...
<title>Shopping cart 2 (responsive)</title>
...
<script src='http://cdnjs.cloudflare.com/ajax/libs/webfont/1.6.22/webfontloader.js'></script>

   <script src="<c:url value="/resources/theme2/js/index.js" />"></script>	
